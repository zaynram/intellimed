...
from trust_generator.logging_setup import setup_logging
...
class TrustGeneratorApp:
    ...
    def __init__(self, root: tk.Tk, config: AppConfig) -> None:
        ...
        try:
            from trust_generator.ui.drafts import purge_old_drafts
    ...
    def _show_entry(self) -> None:
        ...
        ttk.Separator(frame, orient="horizontal").pack(fill=tk.X, pady=5, side=tk.BOTTOM)
        btn_frame = ttk.Frame(frame)
        ...
        from trust_generator.ui.forms import (
            ELECTION_DISPLAY,
            ELECTION_TOOLTIPS,
            ToolTip,
            display_options,
    ...
    def _show_draft_picker(self) -> None:
        ...
        from trust_generator.ui.drafts import delete_draft, list_drafts, load_draft
    ...
    def _entry_to_review(self) -> None:
        ...
        try:
            ...
            self._collect_list_editors(self.data)
            # Apply party labels from the preset dropdown
            self.data.party_a_label = self._custom_a_var.get() or "Husband"
            self.data.party_b_label = self._custom_b_var.get() or "Wife"
    ...
    def _save_draft(self) -> None:
        ...
        from trust_generator.ui.drafts import save_draft
        from trust_generator.ui.forms import flat_to_trust_data
    ...
    def _add_review_sections(
        ...
        from trust_generator.ui.forms import ELECTION_DISPLAY_BY_FIELD
        ...
        from trust_generator.validators import Severity
    ...
    def _run_generation(self) -> None:
        assert self.data is not None
        try:
            from trust_generator.generators import generate_trust_document
