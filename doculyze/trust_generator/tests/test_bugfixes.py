...
from trust_generator.validators import validate as _validate
...
class TestMutualExclusivityValidation:
    ...
    def test_individual_with_party_fields_warns(self):
        ...
        mutual_warnings = [
            ...
            and "party a/b" in f.message.lower()
        ]
...
class TestPronounMap:
    ...
    def _get_phrasing(self, trust_type: TrustType) -> dict[str, str]:
        ...
        from trust_generator.generators.trust_document import _TrustDocGen, DocxFormatter
    ...
    def test_all_keys_present_individual(self):
        ...
        p = self._get_phrasing(TrustType.INDIVIDUAL)
        expected_keys = {
            "subject", "subject_lc", "object", "possessive", "possessive_cap",
            "reflexive", "subject_have", "subject_may", "subject_request",
            "subject_intend", "subject_create", "trustee_ref", "trustee_ref_cap",
            "grantor_ref", "grantor_ref_plural", "grantor_ref_cap",
            "children_possessive",
        }
