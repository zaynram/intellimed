...
from trust_generator.v2.schema import PersonInfo, TrustData, TrustType
from trust_generator.v2.ui.drafts import (
    delete_draft,
    draft_display_name,
    list_drafts,
    load_draft,
...
def _use_tmp_drafts(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("trust_generator.v2.ui.drafts.drafts_dir", lambda: tmp_path)
